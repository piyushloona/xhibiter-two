...
const Dashboard1 = () => {
  ...
  return (
    <div className="dashboard1">
      <div className="container-fluid w-100 p-0 first">
        <div className="header w-100 d-flex justify-content-between align-item-center">
          <button
            className="navbar-toggler ps-3 "
            onClick={() => {
              piyush();
            }}
            type="button"
          ...
          <div className="field_icon d-flex pe-5">
            <div className="field pe-4 p-2 me-2">
              <SearchIcon className="search_icon" />
              <input type="text" />
            </div>
            <button type="button" className="logout p-2 px-4">
                ...
                <div className="congrats">
                  ...
                  <div className="troffy">
                    <div className="heading_h3">
                      <h3>$ 42.8 k</h3>
                      <button type="button"><a href="#" className="text-decoration-none">View Sales </a></button>
                    </div>
                    <img src={troffy} />
                  </div>
                </div>
            ...
            <div className="row row_first">
              <div className="col-xl-4 col-lg-12">
                <div className="weekly">
                  ...
                  <button type="button"><a href="#" className="text-decoration-none"> DETAILS </a></button>
                </div>
              </div>
              <div className="col-xl-4 col-lg-12">
                <div className="total">
